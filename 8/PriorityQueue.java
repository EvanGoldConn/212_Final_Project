...
public class PriorityQueue{
	...
	public void insertEvent(Calendar userCal, String event, int month, int day, int year, int hour, int minutes){ //pass in as a calendar object, don't get user input here (do in main method)
		Calendar currentDate = Calendar.getInstance();
		long currentMiliTime = currentDate.getTimeInMillis();

		if(userCal.getTimeInMillis() < currentMiliTime){
			System.out.print(" ");
	...
	public void displayNextEvent(){
		System.out.println(events[1].getEvent());
		System.out.println("\t"+events[1].getDate().getTime());
	}
